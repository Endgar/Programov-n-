...
for i in range(20):
    heating1.setOutsideTemperature(heating1.getOutsideTemperature() + 1)
    heating2.setOutsideTemperature(heating2.getOutsideTemperature() + 1)
    heating3.setOutsideTemperature(heating3.getOutsideTemperature() + 1)
